...
public class FaceBookDownloadedVideoListAdapter extends RecyclerView.Adapter<FaceBookDownloadedVideoListAdapter.ViewHolder> {
    FragmentActivity requireActivity;
    ArrayList<DownloadedMediaInfoModel> list;
    FaceBookDownloadFragment faceBookDownloadFragment;

    public FaceBookDownloadedVideoListAdapter(FragmentActivity requireActivity, ArrayList<DownloadedMediaInfoModel> list, FaceBookDownloadFragment faceBookDownloadFragment) {
        this.requireActivity = requireActivity;
        this.list = list;
        this.faceBookDownloadFragment = faceBookDownloadFragment;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull FaceBookDownloadedVideoListAdapter.ViewHolder holder, int position) {
    ...
    private void ImageShow(DownloadedMediaInfoModel file) {
    ...
    private void VideoShow(DownloadedMediaInfoModel file) {
