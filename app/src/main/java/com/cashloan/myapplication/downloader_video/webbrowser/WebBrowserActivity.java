package com.cashloan.myapplication.downloader_video.webbrowser;
...
import com.cashloan.myapplication.downloader_video.adapter.WebBrowserAdapter;
...
public class WebBrowserActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new WebBrowser(getString(R.string.metcalfe),"https://www.metcalfe.com/",R.drawable.web_13));
        ...
        list.add(new WebBrowser(getString(R.string.imgur),"https://www.imgur.com/",R.drawable.web_19));
        ...
        list.add(new WebBrowser(getString(R.string.vlipsy),"https://www.vlipsy.com/",R.drawable.web_22));
