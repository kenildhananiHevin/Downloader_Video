...
import static vidmatemaster.fastvideodownloader.allvideodownloader.hdvideodownloader.fragment.facebook.FaceBookDownloadFragment.mutableLiveDataFb;
...
public class FaceBookService extends Service {
    ...
    public void download(String str, String str2, boolean z) {
        ...
        LocaleHelper.setLocale(getApplicationContext(),prefsString);
//        Context updatedContext = changeLanguage(SharedPre.sharedGetString(getApplicationContext(), SELECTEDLANGUAGE));
        ...
        fetch.enqueue(request, new Func<Download>() {
            ...
            public void call(@NonNull Download download) {
                showToast(getApplicationContext(), getResources().getString(R.string.downloadStarted));
                new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        showToast(getApplicationContext(), getString(R.string.downloadCompleted));
            ...
            public void call(@NonNull Error error) {
                showToast(getApplicationContext(), getResources().getString(R.string.somethingWentWrong));
            }
        });
    }
