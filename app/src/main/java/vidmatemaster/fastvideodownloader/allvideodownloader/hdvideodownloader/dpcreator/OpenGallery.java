...
import vidmatemaster.fastvideodownloader.allvideodownloader.hdvideodownloader.adapter.AlbumAdapter;
import vidmatemaster.fastvideodownloader.allvideodownloader.hdvideodownloader.adapter.ImageShowAdapter;
...
public class OpenGallery extends BaseActivity {
    ...
    private List<Pair<String, List<String>>> AlbumLoadImages(OpenGallery activity) {
        ...
        image_recycle.setLayoutManager(new GridLayoutManager(activity,3));
        imageShowAdapter = new ImageShowAdapter(activity,folderlist.get(0).second);
        image_recycle.setAdapter(imageShowAdapter);
