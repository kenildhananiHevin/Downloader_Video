package vidmatemaster.fastvideodownloader.allvideodownloader.hdvideodownloader.dpcreator.dpimage;
...
public class ScaleGestureDetector {
    ...
    Vector2D mCurrSpanVector = new Vector2D();
    ...
    public boolean onTouchEvent(View view, MotionEvent motionEvent) {
        ...
        if (!this.mGestureInProgress) {
            ...
            if (pointerCount > 2) {
                ...
                if (pointerId2 == i3) {
                    int findNewActiveIndex2 = findNewActiveIndex(motionEvent, this.mActiveId1, actionIndex2);
                    ...
                    if (pointerId2 == this.mActiveId1 && (findNewActiveIndex = findNewActiveIndex(motionEvent, i3, actionIndex2)) >= 0) {
                        this.mListener.onScaleEnd(view, this);
            ...
            mFocusX = motionEvent.getX(findPointerIndex2);
            mFocusY = motionEvent.getY(findPointerIndex2);
    ...
    private void setContext(View view, MotionEvent motionEvent) {
        ...
        mFocusX = x3 + (x4 * 0.5f);
        mFocusY = y3 + (y4 * 0.5f);
        mTimeDelta = motionEvent.getEventTime() - motionEvent3.getEventTime();
        mCurrPressure = motionEvent.getPressure(findPointerIndex3) + motionEvent.getPressure(findPointerIndex4);
        mPrevPressure = motionEvent3.getPressure(findPointerIndex) + motionEvent3.getPressure(findPointerIndex2);
    }
